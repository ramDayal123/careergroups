...
class Database{
		...
		private $db_user = "scholars_scholars4you";       // Change as required
		private $db_pass = "7-h*Vh)rd!#0";   // Change as required
		private $db_name = "scholars_career";   // Change as required
